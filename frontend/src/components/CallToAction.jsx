  ...
  return (
    <div className="bg-[#07034d] py-30 text-white text-center">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="px-8 py-3 rounded-full bg-transparent cursor-pointer border-2 border-purple-400 text-white font-semibold text-lg hover:bg-purple-500/20 transition-all duration-300 relative overflow-hidden group  hover:border-white animate-borderMove"
        >
