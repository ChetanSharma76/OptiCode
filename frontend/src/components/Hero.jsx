        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.75 }}
              className="px-4 sm:px-8 py-3 cursor-pointer rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold text-sm sm:text-lg hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 relative overflow-hidden group border-transparent hover:border-white animate-borderMove"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-4 sm:px-8 py-3 cursor-pointer rounded-full bg-transparent border-2 border-purple-400 text-white font-semibold text-sm sm:text-lg hover:bg-purple-500/20 transition-all duration-300 relative overflow-hidden group hover:border-white animate-borderMove"
            >
